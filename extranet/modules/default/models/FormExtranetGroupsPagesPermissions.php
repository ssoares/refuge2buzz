...
<form method="post">
    ...
    <ul>
        <li>
            ...
            <a id="parent_structure_0_open" href="#" onclick="showChild('structure_0')"><?php echo $config->domainName; ?>&nbsp;+</a>
            <a id="parent_structure_0_close" href="#" onclick="hideChild('structure_0')" style="display:none;"><?php echo $config->domainName; ?>&nbsp;-</a>
   ...
   <?php echo $this->getView()->getCibleText('label_gestion_contenu'); ?>
    <ul>
        <li>
            ...
            <a id="parent_data_0_open" href="#" onclick="showChild('data_0')"><?php echo $config->domainName; ?>&nbsp;+</a>
            <a id="parent_data_0_close" href="#" onclick="hideChild('data_0')" style="display:none;"><?php echo $config->domainName; ?>&nbsp;-</a>
