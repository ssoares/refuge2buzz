...
/**
 * Messages and alerts controller.
 * Manage actions for Messages and alerts.
 *
 * @category  Modules
 * @package   Messages
...
class Messages_IndexController extends Cible_Controller_Block_Abstract
{
    ...
    protected $_moduleTitle   = 'messages';
    ...
    /**
     * Allocates action for videos management.<br />
...
//            $this->_disableExportToExcel = true;
            ...
            $this->_colTitle = array(
                'MA_ID'    => array('width' => '150px'),
                'MAI_Title' => array('width' => '150px'),
                'MA_Online' => array('width' => '150px'),
                'MA_Timeout' => array('width' => '150px')
                );
...
//                $formData['LANGUAGE'] = $this->getCurrentEditLanguage();
    ...
    private function _listAction($objectName)
    {
        ...
        $params = array('constraint' => $this->_constraint);
