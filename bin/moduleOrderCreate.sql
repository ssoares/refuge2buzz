...
-- Version SVN: $Id: moduleOrderCreate.sql 1368 2013-12-27 04:29:06Z ssoares $
...
REPLACE INTO `Static_Texts` (`ST_Identifier`, `ST_LangID`, `ST_Value`, `ST_Type`, `ST_Desc_backend`, `ST_Editable`, `ST_ModuleID`) VALUES
('form_label_CP_ShippingFees', 1, "Frais de transport", 'cible', '', 0, 17),
('form_label_CP_ShippingFees', 2, 'Transportation fees', 'cible', '', 0, 17),
('form_label_CP_ShippingFeesLimit', 1, "Limit des frais de transport", 'cible', '', 0, 17),
('form_label_CP_ShippingFeesLimit', 2, 'Limit transportation costs', 'cible', '', 0, 17),
('form_label_CP_MontantFraisCOD', 1, "Frais pour le COD", 'cible', '', 0, 17),
('form_label_CP_MontantFraisCOD', 2, 'Fees for COD', 'cible', '', 0, 17),
('form_label_CP_AdminOrdersEmail', 1, "Courriel pour les commandes", 'cible', '', 0, 17),
('form_label_CP_AdminOrdersEmail', 2, 'Email for orders', 'cible', '', 0, 17),
('form_label_CP_FreeItemID', 1, "Item gratuit", 'cible', '', 0, 17),
('form_label_CP_FreeItemID', 2, 'Free item', 'cible', '', 0, 17),
('form_label_CP_FreeMiniAmount', 1, "Montant minimum pour l'item gratuit", 'cible', '', 0, 17),
('form_label_CP_FreeMiniAmount', 2, 'Minimum amount for the item free', 'cible', '', 0, 17),
('form_label_CP_BonusPointDollar', 1, "Point bonis par dollar d'achat", 'cible', '', 0, 17),
('form_label_CP_BonusPointDollar', 2, 'Bonus Point per dollar', 'cible', '', 0, 17),
('form_label_CP_TauxTaxeFed', 1, "Taxe fédérale", 'cible', '', 0, 17),
('form_label_CP_TauxTaxeFed', 2, 'Federal tax', 'cible', '', 0, 17),
('form_label_CP_OrderMiniAmount', 1, "Montant minimum pour commander", 'cible', '', 0, 17),
('form_label_CP_OrderMiniAmount', 2, 'Minimum amount to order', 'cible', '', 0, 17),
('form_label_CP_ShipFeeUSA', 1, "Frais de transport - USA", 'cible', '', 0, 17),
('form_label_CP_ShipFeeUSA', 2, 'Transportation fees - USA', 'cible', '', 0, 17),
('form_label_CP_ShipFeeOther', 1, "Frais de transport - Autre", 'cible', '', 0, 17),
('form_label_CP_ShipFeeOther', 2, 'Transportation fees - Other', 'cible', '', 0, 17),
