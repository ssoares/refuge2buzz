...
class Cible_Form_Element_ImagePicker extends Zend_Form_Element_Hidden
{
    ...
    public function render(Zend_View_Interface $view = null)
    {
        ...
        $content .=  "&nbsp;&nbsp;<img class='action_icon' alt='Supprimer' src='".$_baseUrl."/icons/button_cancel_16x16.png' onclick='separateImage(\"".$this->associatedElement."\",\"".$defaultImage."\",\"".$this->getId()."\")' />";
