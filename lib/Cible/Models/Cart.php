...
//        {
            ...
            $html .= '<div class="col-xs-12 hidden-md hidden-lg">' . chr(13);
            $html .= '<p class="col-xs-4 hidden-md hidden-lg">' . Cible_Translation::getClientText('form_item_qty_label') .'</p>' . chr(13);
            $html .= '<p class="col-xs-4 hidden-md hidden-lg">' . Cible_Translation::getClientText('unit_price_label') .'</p>' . chr(13);
            $html .= '<p class="col-xs-4 hidden-md hidden-lg text-rigth">' . Cible_Translation::getClientText('cart_item_total_label') .'</p>' . chr(13);
            $html .= '</div>' . chr(13);
            $html .= '<div id="price' . $suffixIds .'" class="col-xs-4 col-lg-4">' . chr(13);
            if($data['PromoId'])
            {
            ...
            $html .= '</div>' . chr(13);
            $html .= '<div id="unitPrice' . $suffixIds .'" class="sumLine col-xs-4 col-lg-4">' . chr(13);
            $html .= ' <span class="unitPrice">'  . $unitPrice . '</span> $' . chr(13);
            $html .= '</div>' . chr(13);
            $html .= '<div id="sumLine' . $suffixIds .'" class="sumLine col-xs-4 col-lg-4 text-right">' . chr(13);
...
//        {
            ...
            $html .= '<p class="col-xs-4 hidden-md hidden-lg text-rigth">' . Cible_Translation::getClientText('cart_item_total_label') .'</p>' . chr(13);
            $html .= '</div>' . chr(13);
            $html .= '<div id="price' . $suffixIds .'" class="col-xs-4 col-lg-4 text-center">';
            ...
            $html .= '</div>';
            $html .= '<div id="unitPrice' . $suffixIds .'" class="sumLine col-xs-4 col-lg-4 text-right">' . chr(13);
            if($pricePromo > 0)
